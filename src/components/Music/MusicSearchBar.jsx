    ...
    <div className="mb-6 sm:mb-8">
      <div className="mx-auto w-full max-w-2xl">
        <div className="group relative overflow-hidden rounded-lg border border-white/15 bg-black/45 shadow-[0_18px_45px_rgba(0,0,0,0.28)] backdrop-blur-md transition duration-300 focus-within:border-primary/70 focus-within:shadow-[0_0_0_1px_hsl(var(--primary)/0.35),0_18px_50px_rgba(0,0,0,0.34)]">
          ...
          <div className="relative flex min-h-[58px] items-center gap-3 px-4 sm:px-5">
            <div className="grid h-10 w-10 shrink-0 place-items-center rounded-md border border-white/10 bg-white/[0.04] text-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
            ...
            <div className="min-w-0 flex-1">
              ...
              <input
                ...
                className="w-full bg-transparent py-3 font-heading text-xl font-semibold text-white outline-none placeholder:text-white/38 sm:py-0"
              />
            </div>

            <div className="hidden h-9 items-end gap-1 border-l border-white/10 pl-4 sm:flex">
            ...
            {searchTerm && (
              <button
                type="button"
                onClick={handleClear}
                className="grid h-9 w-9 shrink-0 place-items-center rounded-md border border-white/10 bg-white/[0.04] text-white/70 transition hover:border-white/25 hover:bg-white/10 hover:text-white focus:outline-none focus:ring-2 focus:ring-primary/50"
          ...
          <div className="relative grid grid-cols-12 gap-px border-t border-white/10 bg-white/[0.03] px-4 py-1.5">
