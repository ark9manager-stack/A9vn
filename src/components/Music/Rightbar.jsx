...
const Rightbar = ({
  ...
  // ✅ ẨN HOÀN TOÀN khi đóng (không còn lòi 1 góc)
  if (!open) return null;

  return (
    <>
      {/* ✅ Backdrop chỉ cho MOBILE để tránh lyric + playlist đè nhau */}
      <div
      ...
      <aside
        className={`
          fixed z-50 bg-black border border-gray-700 rounded-xl shadow-2xl
          w-full h-full right-0 top-0
          md:w-[360px] md:h-[80vh] md:right-6 md:top-1/2 md:-translate-y-1/2
        `}
