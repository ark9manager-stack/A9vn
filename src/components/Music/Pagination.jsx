...
const Pagination = ({
  ...
  return (
    ...
    >
      <div className="relative flex items-center gap-3 rounded-lg border border-white/12 bg-black/35 px-3 py-3 shadow-[0_16px_38px_rgba(0,0,0,0.24)] backdrop-blur-md">
