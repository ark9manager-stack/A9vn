...
const MODULE_IMPORTERS = {
  ...
  pageMainPath: () => import("../pages/MainPath"),
  pageSidePath: () => import("../pages/SidePath"),
  pageComicManga: () => import("../pages/ComicManga"),
...
const MODULE_LABELS = {
  ...
  pageMainPath: "MainPath page",
  pageSidePath: "SidePath page",
  pageComicManga: "ComicManga page",
